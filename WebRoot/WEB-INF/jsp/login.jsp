						...
						<table>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"/><img id="checkImg" class="captchaImage" src="checkImg.action" onclick="change()" title="点击更换验证码"/>
										</span>
									</td>
								</tr>
							<tr>
