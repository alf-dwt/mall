...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminsecond_update.action" method="post">
					...
					<td class="ta_01" bgColor="#ffffff">
						<select name="category.cid">
							<s:iterator value="cList" var="c">
								<option value="<s:property value="#c.cname"/>" <s:if test="model.category.cid==#c.cid">selected</s:if>><s:property value="#c.cname"/></option>
							</s:iterator>
						</select>
					</td>
				</tr>
